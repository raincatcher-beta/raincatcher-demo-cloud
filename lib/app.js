...
var mbaasApi = require('fh-mbaas-api')
  ...
  , adminRouter = require('./app/admin/router')(mediator)
  , fhComponentMetrics = require('fh-component-metrics')
  ;

var metricsConf = config.get('metrics') || {};
var metrics = fhComponentMetrics(metricsConf);

if (metricsConf.enabled === 'true') {
