...
wfmSync.init(mediator, mbaasApi, 'workorders', config.get("syncOptions"));
wfmSync.init(mediator, mbaasApi, 'result', config.get("syncOptions"));
wfmSync.init(mediator, mbaasApi, 'workflows', config.get("syncOptions"));
wfmSync.init(mediator, mbaasApi, 'messages', config.get("syncOptions"));
