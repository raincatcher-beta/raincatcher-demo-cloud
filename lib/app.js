...
module.exports = function() {
  ...
  return mongoUtil.getMongoURL().then(function(mongoConnectionString) {
    ...
    return mongooseStore.connect(mongoConnectionString)
      .then(function() {
        //Connecting and authenticating to google sheets.
        return googleSheetStore.connect({
          documentId: config.get('sheetStoreConfig').documentId,
          credentials: require('./google-creds.json')
        });
      })
      .then(function() {
