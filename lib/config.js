...
var autoconfig = function(overrides) {
  var config = cc(overrides).add({
    ...
    "workorderDatasetId": "workorders",
    syncFields: {
      result: ['_localuid', 'stepResults'],
      workorders: ['id', 'workflowId', 'assignee', 'type', 'title', 'status', 'address', 'summary'],
      workflows: ['id',  'title'],
      workflowStep: ['code', 'name', 'templates']
    },
    syncMetrics: {
    ...
    sheetStoreConfig: {
      "documentId": "1eu93dxzpSB58Ld2o0IfGj9AjCbaMJKl-Qjt-1-6-Oz0",
      "sheetIds": {
        "workorders": "workordersheet"
      }
    }
