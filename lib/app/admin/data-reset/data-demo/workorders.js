...
module.exports = function getSampleData() {
  ...
  // Reset the workorder dates to today, this is for demo purposes to allow viewing workorders in the scheduler
  var today = new Date();
