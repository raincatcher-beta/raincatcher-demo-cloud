...
var workflows = [
  { id: 0, title: 'Static forms', steps: [
    {code: 'risk-assessment', name: 'Risk Assessment', templates: {
      ...
      view: '<risk-assessment value="workorder.results[\'risk-assessment\'].submission"></risk-assessment>'
    }},
    {code: 'vehicle-inspection', name: 'Vehicle Inspection', templates: {
      form: '<vehicle-inspection-form></vehicle-inspection-form>',
      view: '<vehicle-inspection value="workorder.results[\'vehicle-inspection\'].submission"></vehicle-inspection>'
    }}
  ]},
